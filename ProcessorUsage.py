...
def START():
    ...
    GetSettingRETURN = GetSetting(
        root, SettingScreen, MainScreen, unitsIndex, fontHEAD, FONT, red, blue, UNITS)
...
def update_process():
    UpdateProcess(RESOURCE, currFrame, lenCurr, highFrame, lenHigh, highData,
                  removeRate, decimal, unit, unitValue, heading_Main, currHead, cpu)
...
SettingScreen = SettingScreenCreate(
    root, START, FONT, bgColor, unitsIndex, UNITS)
